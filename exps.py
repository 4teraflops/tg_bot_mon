...
import json
import os
from extentions.demo_checker.src import config
import time
import hashlib
import random
...
def card_registration():
    ...
    #logger.info(f'registration_url: {registration_url}')
    ...
    if reg_request.status_code == 200:
        ...
        output.append(f'Something wrong! url: {url} response: {reg_request}\n')
